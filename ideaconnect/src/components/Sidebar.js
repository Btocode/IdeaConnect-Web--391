    ...
    <div className="px-6 bg-gray-900 text-lg sticky top-0">
      <div className="flex justify-start min-h-screen bg-gray-200">
        <div className=" bg-gray-900 ">
          ...
          <div className="pl-6 pr-4 py-2 bg-gray-600 flex items-center justify-between">
            ...
            <button
              className="text-gray-400 bg-gray-700 rounded focus:outline-none focus:ring-1 focus:ring-gray-500 focus:text-white" onClick={logoutUser}
            >
            ...
            <div className="temp hidden" id="options">
              Hello
            </div>
          </div>
        </div>
